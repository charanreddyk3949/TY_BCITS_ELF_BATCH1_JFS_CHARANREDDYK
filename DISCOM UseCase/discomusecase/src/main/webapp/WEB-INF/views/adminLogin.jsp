...
<% } %>
	...
	<div class="container">
		...
		<form id="cform" action="../admin/adminLogin" method="post">
			<h1>Admin Login</h1>
			<br>
			<br>
			<br> <input type="image" src="${images}/user.png" alt="">
			<input type="number" name="adminId" id="adminId" placeholder="admin Id"><br>
			<br> <input type="password" name="password"placeholder="password"><br><br>			
			<div id="nemp" style="margin-left: 150px">
				 <a href=" "> SIGNUP</a> &nbsp; | &nbsp; 
				 <a href="/forgot-user-id" target="_self" title="Forgot User ID?">Forgot
					Password</a>
			</div>
			<br>
