...
<div class="container">
    ...
    <form action="../consumer/paymentSuccessPage" style="border: 1px solid black;width: 600px;height: 540px;border-radius: 10px;background-color:lavender; margin-left: 300px; ">
