...
public class TestManyToOneBidirectionalGetAddress {
...
//			addressInfo.setPrimaryInfo(primaryInfo);
			...
			EmployeePrimaryInfo info = manager.find(EmployeePrimaryInfo.class, 21);
			System.out.println(info.getAddress().get(0).getAddress1());
			System.out.println(info.getAddress().get(1).getAddress2());
