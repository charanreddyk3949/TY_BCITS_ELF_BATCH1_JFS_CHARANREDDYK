      ...
      <body background="${images}/power-lines-fields-seen.jpg" style="background-size:cover;background-position: center; 
           ...
           <!--  <form id="consumersignupform"  > -->
             <h1 id="heading">DISCOM Consumer Registration</h1>
              <form action="../consumer/addConsumer" name="signin" method="post" onsubmit= "validateForm(); return  false">
                <div class="form-row" >
                  <div class="col">
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <input type="email" class="form-control" id="email"name="email" placeholder="enter email ID" required="required">
                </div>
                <div class="form-group col-md-12" style="margin-top: -20px;">
                <label for="inputAddress">Mobile Number</label>
                <input type="number" class="form-control" id="mobileNumber"name="mobileNumber" style="height: 25px" placeholder="enter mobile number..." required="required">
              </div>
              </div>
              <div class="form-group" style="margin-top: -20px;">
                <label for="inputAddress">Address</label>
                <input type="text" class="form-control" id="address1"name="address1" placeholder="HouseNo.street..." required="required">
              </div>
              <div class="form-group"style="margin-top: -20px;">
                <label for="inputAddress2">Address 2</label>
                <input type="text" class="form-control" id="address2"name="address2" placeholder="Address..." required="required">
              </div>
              <div class="form-row"style="margin-top: -20px;">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select id="inputState" class="form-control" id="state" name="state" style="height: 25px;font-size:15px;padding-top:0px" required="required">
                ...
                <div class="form-row" style="margin-top: -20px;">
                  <div class="col">
                    ...
                    <select id="inputState" class="form-control"id="region" name="region"style="height: 25px;font-size:15px;padding-top:0px" required="required">
                  ...
                  <div class="col">
                    ...
                    <select id="inputState" class="form-control"id="consumerType" name="consumerType"style="height: 25px;font-size:15px;padding-top:0px" required="required">
              ...
              <div class="form-group"style="margin-top: 0px;">
                ...
                <input type="text" class="form-control" id="rrNumber" name="rrNumber" placeholder="enter rr number..." required="required">
              </div>
