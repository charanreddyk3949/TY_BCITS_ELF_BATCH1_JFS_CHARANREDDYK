...
<form class="form-inline my-2 my-lg-0">
 ...
 <%if (employeeMaster != null) { %>
       <div style="margin-top: -300px;">
          <table style="margin-left: 800px;font-size: 20px;border: 1px;color: white;" >
           <h1 style="margin-left: 800px;color:  navy">Employee Details</h1>
  ...
  <%if(consumersMasterBeanList != null){ %>
   <h1 style="margin-left: 700px;color: navy;margin-top : -200px;">Consumer Details</h1>
   <table style="margin-left: 450px;font-size: 20px;margin-top : 0px;border: 1px;width: 70%;color:white;background: black" >
