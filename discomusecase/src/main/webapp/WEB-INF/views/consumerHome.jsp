       ...
       <h3 style="color: navy">Pending bills</h3>
           <table border="1" style="width: 1200px;background-color: black">
              ...
              <tr style="height: 50px;font-size: 17px;text-align: center;">
                  ...
                  <td style="height: 50px;width: 150px"><a href="../consumer/paymentPage?rrNumber=
                  <%=pendingBills.getBillHistoryPK().getRrNumber()%>" style="background-color: aqua;">pay Now</a></td>
